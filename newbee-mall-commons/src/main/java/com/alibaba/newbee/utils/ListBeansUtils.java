 ...
 * @author
 */
public class ListBeansUtils extends BeanUtils {
     ...
     */
    public static <S, T> List<T> copyListProperties(List<S> sources, Supplier<T> target, ListBeansUtilsCallBack<S, T> callBack) {
